...
import com.yayiktereyagi.www.yayiktereyagi.model.Firma;
...
public class SiparisActivity extends AppCompatActivity  {
    ...
    final static long ENKISA_ZAMANDA = 0;
    final static long UC_BES_GUN_ICINDE = 1;
    final static long BES_YEDI_GUN_ICINDE = 2;
    long mWhen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        long when = intent.getLongExtra(MainActivity.WHEN,0);
        mWhen =when;
    ...
    public void gonder(View view){
       ...
       // Firma siparis= new Firma(companyName, personName,kilogramName, deadline, tarih, siparisDurum);
        //siparis olustur
        Siparis yeniSiparis = new Siparis(kisiAdi, tarih, miktar, neZaman, siparisDurum);
        //ekle(siparis);
        ekle(yeniSiparis);
    }
